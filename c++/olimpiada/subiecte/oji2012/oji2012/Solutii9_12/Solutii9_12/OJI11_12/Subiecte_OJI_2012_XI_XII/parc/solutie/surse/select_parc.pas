...
procedure selectsort(var a:matrice;n:longint);      {pistele de biciclete le sortez in ordine crescatoare}
var i,j:longint;
begin
	for i:=1 to n-1 do
		for j:=i+1 to n do
...
begin
	...
	selectsort(pv,m);                           {sortez punctele in ordine crescatoare}
	...
	selectsort(po,n);                           {sortez punctele in ordine crescatoare}
