...
namespace Atestat11 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class Table1DataTable : global::System.Data.TypedTableBase<Table1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public Table1Row AddTable1Row(string Nume, string Partid, string Judet) {
        ...
        public partial class Table1Row : global::System.Data.DataRow {
            ...
            public string Partid {
                get {
                    try {
                        return ((string)(this[this.tableTable1.PartidColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Partid\' in table \'Table1\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable1.PartidColumn] = value;
                }
            }
            ...
            public string Judet {
                get {
                    try {
                        return ((string)(this[this.tableTable1.JudetColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Judet\' in table \'Table1\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable1.JudetColumn] = value;
                }
            }
            ...
            public bool IsPartidNull() {
                return this.IsNull(this.tableTable1.PartidColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetPartidNull() {
                this[this.tableTable1.PartidColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public bool IsJudetNull() {
                return this.IsNull(this.tableTable1.JudetColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetJudetNull() {
                this[this.tableTable1.JudetColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Atestat11.Database1DataSetTableAdapters {
    ...
    public partial class Table1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table1] WHERE (([Id] = @Original_Id) AND ((@IsNull_Nume = 1 AND [Nume] IS NULL) OR ([Nume] = @Original_Nume)) AND ((@IsNull_Partid = 1 AND [Partid] IS NULL) OR ([Partid] = @Original_Partid)) AND ((@IsNull_Judet = 1 AND [Judet] IS NULL) OR ([Judet] = @Original_Judet)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table1] ([Nume], [Partid], [Judet]) VALUES (@Nume, @Partid, @J" +
                "udet);\r\nSELECT Id, Nume, Partid, Judet FROM Table1 WHERE (Id = SCOPE_IDENTITY())" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table1] SET [Nume] = @Nume, [Partid] = @Partid, [Judet] = @Judet WHERE (([Id] = @Original_Id) AND ((@IsNull_Nume = 1 AND [Nume] IS NULL) OR ([Nume] = @Original_Nume)) AND ((@IsNull_Partid = 1 AND [Partid] IS NULL) OR ([Partid] = @Original_Partid)) AND ((@IsNull_Judet = 1 AND [Judet] IS NULL) OR ([Judet] = @Original_Judet)));
SELECT Id, Nume, Partid, Judet FROM Table1 WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Partid", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Partid", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Atestat11.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nume, Partid, Judet FROM dbo.Table1";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Id, Nume, Partid, Judet FROM dbo.Table1 WHERE partid = @partid ORDER BY Ju" +
                "det";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@partid", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Partid", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "INSERT INTO [dbo].[Table1] ([Nume], [Partid], [Judet]) VALUES (@Nume, @Partid, @J" +
                "udet);";
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Partid", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Partid", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Judet", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Judet", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Afisare(Database1DataSet.Table1DataTable dataTable, string partid) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((partid == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(partid));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        public virtual Database1DataSet.Table1DataTable GetDataBy1(string partid) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((partid == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        public virtual int Delete(int Original_Id, string Original_Nume, string Original_Partid, string Original_Judet) {
            ...
            if ((Original_Judet == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_Judet));
            }
        ...
        public virtual int Insert(string Nume, string Partid, string Judet) {
            if ((Nume == null)) {
        ...
        public virtual int Update(string Nume, string Partid, string Judet, int Original_Id, string Original_Nume, string Original_Partid, string Original_Judet, int Id) {
            if ((Nume == null)) {
            ...
            if ((Original_Partid == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_Partid));
            }
            if ((Original_Judet == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nume, string Partid, string Judet, int Original_Id, string Original_Nume, string Original_Partid, string Original_Judet) {
            return this.Update(Nume, Partid, Judet, Original_Id, Original_Nume, Original_Partid, Original_Judet, Original_Id);
        }
        ...
        public virtual int InsertQuery(string Nume, string Partid, string Judet) {
            ...
            if ((Judet == null)) {
                ...
                command.Parameters[2].Value = ((string)(Judet));
            }
