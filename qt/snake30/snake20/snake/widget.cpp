    ...
    ui(new Ui::Widget)
{
    ...
    loadButton->setGeometry(450,5,100,50);
    loadButton->setText("Load Preset");

    inputs = new QComboBox(this);
    inputs->setFocusPolicy(Qt::NoFocus);
    inputs->setGeometry(450,60,100,30);
    inputs->addItem("Preset1");
    inputs->addItem("Preset2");
    inputs->addItem("Preset3");
